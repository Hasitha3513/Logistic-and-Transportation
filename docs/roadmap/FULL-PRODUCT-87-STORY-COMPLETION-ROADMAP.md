...
**Wave A is 2 / 2 COMPLETE / CLOSED and Wave B is OPEN.** US-73 provides one accepted governed outbound JSON-file adapter with controlled-sandbox evidence. US-78 is independently accepted with Routing and Delivery flowing through one Operations lifecycle while preserving source ownership and P1-01 durability. US-35 and US-37 final acceptance pass; US-38 product decisions are frozen while US-46 and US-47 remain in Wave B. The next task is `US-38-FUEL-EXCEPTIONS-IMPLEMENTATION-001`.
...
| US-38 | Handle Fuel Exceptions | `fuel` | PRODUCT_DECISIONS_FROZEN / IMPLEMENTATION_NOT_STARTED | P1 | B | H/M/H/M/H | US-31/32/33/34/35/36/37, US-78 intake, Audit, Notification | NONE for Phase 1; accepted local facts and controlled Fuel Card fixture | Frozen: six safe categories, Fuel-local lifecycle, immutable evidence, owner-command correction, independent approval, durable US-78 handoff | YES; next free version after V65 | frozen `/api/v1/fuel/exceptions` queries and explicit commands | OPERATOR UI under Fuel/AppLayout | five permissions; Tenant; targeted SoD; minimized financial/card/Driver evidence | Fuel owns meaning/correction; Operations owns central lifecycle; no foreign persistence or duplicate engine | US-46/47 decisions | NONE | COMPLETE; `US-38-FUEL-EXCEPTIONS-PRODUCT-DECISIONS-001.md` | Implement all six paths without corrupting history; PostgreSQL/Chromium and US-35/37/Bunker/US-78 regressions; DoD-C |
...
`US-38-FUEL-EXCEPTIONS-IMPLEMENTATION-001`
