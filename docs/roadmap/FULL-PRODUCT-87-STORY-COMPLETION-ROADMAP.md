...
| US-87 | Detect User Risk | `identity` | IMPLEMENTATION_IN_PROGRESS / CS01_COMPLETE / CS02_AUTHORIZATION_PENDING | P2 | E | H/M/H/H/H | Identity permission-ceiling source is present; audit/workflow remain feature-owned; US-82 optional | No external dependency for first signal; IdP/session authority remains later-wave | APPROVED FIRST WAVE: four Identity permission-ceiling actions; three distinct denials in 15 minutes; MEDIUM advisory review; no misconduct conclusion or automatic action | YES, ONLY AFTER SEPARATE DDL AUTHORIZATION; NO VERSION RESERVED | CS01 internal minimized denial contract exists; no producer or public contract active | proposed OPERATOR UI | Tenant; distinct reviewer; exact field allow-list; approved 180-day retention; current runtime has no MFA/device-bound session enforcement | Identity owns source and assessment; no generic denial capture, audit scraping, Operations intake or foreign persistence | US-82 optional analytics, US-84 | CS02 exact DDL/migration authorization; later slices independently authorized | CS01 domain/contract tests and boundaries pass; authorize exact CS02 persistence boundary next | Technical fixtures remain distinct from authorized reviewer/producer acceptance; `US-87-DETECT-USER-RISK-CS01-DOMAIN-SIGNAL-CONTRACTS-001.md` |
