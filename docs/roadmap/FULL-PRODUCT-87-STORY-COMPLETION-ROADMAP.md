...
**Wave A is 2 / 2 COMPLETE / CLOSED and Wave B is OPEN.** US-73 provides one accepted governed outbound JSON-file adapter with controlled-sandbox evidence. US-78 is independently accepted with Routing and Delivery flowing through one Operations lifecycle while preserving source ownership and P1-01 durability. US-35 and US-37 final acceptance pass; US-38, US-46, and US-47 remain in Wave B. The next task is `US-38-FUEL-EXCEPTIONS-PRODUCT-DECISIONS-001`.
...
| US-38 | Handle Fuel Exceptions | `fuel` | READY_FOR_PRODUCT_DECISIONS | P1 | B | H/M/H/M/H | US-31/32/33/34/35/36, US-78 workflow contract, Audit, Notification | Fuel-card feed for card-misuse case | exception taxonomy/lifecycle; correction approval; stock/cost effects; evidence/retention; US-78 handoff | YES | new command/query APIs | OPERATOR UI | RBAC/SoD; Tenant; financial/fraud evidence | Partial delivery before accepted US-35 facts would omit required card misuse and violate source completeness | US-47 after US-35 contract | NONE; US-35 and US-78 prerequisites accepted | Freeze all six cases and correction/approval boundaries from accepted source contracts | Theft/wrong reading/price/emergency/card/negative-balance paths pass without corrupting history; DoD-C |
...
`US-38-FUEL-EXCEPTIONS-PRODUCT-DECISIONS-001`

It must freeze US-38 ownership, lifecycle, correction, evidence, security, integration, and acceptance contracts before implementation.
