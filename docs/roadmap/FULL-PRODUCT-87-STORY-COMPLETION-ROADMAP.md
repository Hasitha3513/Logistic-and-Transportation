...
US-51 D1-D11 are approved and
`US-51-MONITOR-IDLE-TIME-CS01-CANONICAL-ENGINE-SEMANTICS-001` is complete. Canonical V3 is validated,
but production publication, consumers and source capability remain gated at V100. The exact next
change set is `US-51-MONITOR-IDLE-TIME-CS02-V101-HISTORY-CAPABILITY-001`; it must verify V101 is free
before adding immutable V3 history and effective capability persistence.
