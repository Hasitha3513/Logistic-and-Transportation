...
| US-72 | Enforce Compliance | justified `compliance` decision/evidence context; domains own facts | PREREQUISITE_DECISION_PACKAGE_PROPOSED / IMPLEMENTATION_NOT_AUTHORIZED | P1 | D | H/H/H/H/H | Fleet, Driver/Fleet, Freight/Hazmat, US-47 billing, US-83 retention, US-75 Audit, Identity, US-80 Workflow — platform prerequisites satisfied | Regulatory/tax policy authority; optional rules feed | D1–D11 proposed: jurisdictions/authority; typed checks; effects; evidence states; effective versions; override/appeal/SoD; retention/privacy; contracts/security/acceptance | REQUIRED AFTER DDL AUTHORIZATION; NO VERSION RESERVED | proposed compliance decision API + published typed fact ports/events | proposed OPERATOR UI | proposed RBAC/ABAC/SoD; Tenant; minimized driver/medical/cargo/tax data | Avoid one expression-language “god engine”; explicit typed checks consume published facts | US-76 product decisions | product and qualified policy authority approval; Tracking physical holds are not dependencies for the proposed catalogue | Product owner and qualified policy authority approve D1–D11, initial jurisdiction, checks/effects/override/retention; no implementation before approval | Vehicle/driver/cargo/hazmat/tax/regional/retention decisions are auditable and block/flag correctly; DoD-C |
...
16. US-72 prerequisite package is `PROPOSED / IMPLEMENTATION_NOT_AUTHORIZED`; after product and qualified policy authority approve D1–D11, execute the approved bounded change sets → closure → acceptance.
