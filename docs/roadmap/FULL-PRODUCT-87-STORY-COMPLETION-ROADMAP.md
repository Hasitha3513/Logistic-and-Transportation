...
**Current state:** 72 / 87 accepted; 15 / 87 remaining; Waves A and B are COMPLETE / CLOSED; Wave C is active; US-48 is implementation complete with physical acceptance on external-prerequisite hold; US-49 CS01–CS03 are complete and implementation continues
...
| US-49 | Manage Geofences | `tracking` | IMPLEMENTATION_IN_PROGRESS / CS01-CS03_COMPLETE | P1 | C | H/M/H/M/H | US-48 position stream, Organization active-location lookup, Notification, Audit | NONE after telemetry exists | FROZEN: DEPOT/CUSTOMER_SITE/UNAUTHORIZED_ZONE; polygon-only; two-position confirmation; no dwell; independent overlap; unauthorized HIGH | V77 | proposed `/api/v1/tracking/geofences` family + `VehicleGeofenceTransitionedV1` | OPERATOR UI | three narrow permissions; Tenant; minimized location evidence | Logical location IDs only; no US-63 ownership/persistence reuse | US-50, US-51, US-52 | frozen US-48 trusted WGS84/Vehicle/source-time contracts | CS01 domain/ports, CS02 V77 persistence and CS03 bounded evaluation/transitions COMPLETE | Must prove API/RBAC/audit, Notification, frontend, closure and independent E2E; no US-48 acceptance inheritance |
...
US-48 external acceptance remains on hold until physical FMC130/live Flespi prerequisites change. US-49 CS01–CS03 are verified complete without story acceptance credit; CS04 owns management APIs, RBAC and audit.
