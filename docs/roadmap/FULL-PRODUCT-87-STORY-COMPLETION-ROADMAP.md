...
**Architecture enabler:** `P1-01` COMPLETE; current Flyway head `V95`
...
| US-55 | Handle GPS Edge Cases | `tracking` | IMPLEMENTATION_IN_PROGRESS / CS02_COMPLETE | P1 | C | H/H/H/H/H | US-48 ingestion/trusted state, hybrid Kafka/Redis/Timescale, US-78, Notification, Audit | Real device/provider loss, burst, reassignment, tamper and battery evidence for final acceptance | exact coordinate/accuracy/time/order/jump/freshness/battery thresholds; canonical V2 optional observations; unsupported signals UNKNOWN; two-point recovery; immutable evidence | capability persistence and optional-signal persistence require CS03 authorization; V95 unchanged | proposed bounded `/api/v1/tracking/gps-exceptions` list/detail/acknowledge only | permission-gated operator page plus warnings on existing Tracking surfaces | Tenant/source-time binding retained; V1/V2 DLT and low-cardinality/privacy rules verified | Tracking owns detection/evidence; Operations owns HIGH case workflow; Notification owns IN_APP delivery | CS02 PASS: focused 76/76, Kafka 2/2, Timescale 11/11, Redis 4/4, Maven 1,861/1,861 | V1 immutable; no dual publication; no tamper/battery inference and no physical-acceptance inheritance | `US-55-HANDLE-GPS-EDGE-CASES-CS03-PERSISTENCE-AUTHORIZATION-001` | Technical and physical acceptance remain separate |
...
US-48, US-50, US-52, US-53 and US-54 remain on independent external acceptance holds. US-49 is COMPLETE / ACCEPTED and accounting remains 73 / 87. US-54 technical closure remains valid, but no physical case was executed and simulation was not substituted. US-55 CS02 is complete without claiming unavailable physical tamper/battery fidelity. The active queue is US-55 CS03 persistence authorization; Flyway remains V95.
