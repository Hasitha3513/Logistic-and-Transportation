...
| US-54 | View Tracking Dashboard | `tracking` | PRODUCT_DECISIONS_AUTHORIZED | P2 | C | H/L/H/M/M | US-48..53 technical producer contracts, Reporting conventions, Notification | Map tile/geospatial service if selected | widgets; freshness; heat-map privacy; refresh/load budget; alert aggregation | NO | aggregate read API | DASHBOARD | RBAC/ABAC; Tenant; location aggregation/privacy | Must consume producer contracts; dashboard contains no detector | NONE in same wave once producers stable | Frozen technical US-48..53 producer contracts; no physical acceptance inheritance | Execute `US-54-VIEW-TRACKING-DASHBOARD-PRODUCT-DECISIONS-001` | Fleet overview/exceptions/alerts/heat maps derive from authoritative data and label stale state; own E2E required |
