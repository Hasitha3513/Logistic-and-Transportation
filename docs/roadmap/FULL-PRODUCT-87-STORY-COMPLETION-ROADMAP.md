...
10. US-50 product decisions, CS01 domain/ports and CS02 V81 persistence — COMPLETE; next evaluation → API/RBAC → Notification → frontend → concurrency/performance → closure → acceptance.
