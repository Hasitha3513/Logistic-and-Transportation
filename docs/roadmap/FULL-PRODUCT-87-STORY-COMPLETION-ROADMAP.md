...
**Current state:** 72 / 87 accepted; 15 / 87 remaining; Waves A and B are COMPLETE / CLOSED; Wave C is active; US-48 is implementation complete with physical acceptance on external-prerequisite hold; US-49 product decisions are complete and implementation is pending
**Architecture enabler:** `P1-01` COMPLETE; current Flyway head `V76`
...
**Waves A and B are COMPLETE / CLOSED; Wave C is active.** US-73 and US-78 are accepted. US-35, US-37, US-38, US-46, and US-47 final acceptance pass. US-48 is technically complete but physical acceptance is `ON_HOLD_EXTERNAL_PREREQUISITE`; US-49 CS01 domain/ports and CS02 V77 persistence are complete and the next task is `US-49-MANAGE-GEOFENCES-CS03-EVALUATION-TRANSITIONS-001`.
...
| US-49 | Manage Geofences | `tracking` | PRODUCT_DECISIONS_COMPLETE / IMPLEMENTATION_PENDING | P1 | C | H/M/H/M/H | US-48 position stream, Organization active-location lookup, Notification, Audit | NONE after telemetry exists | FROZEN: DEPOT/CUSTOMER_SITE/UNAUTHORIZED_ZONE; polygon-only; two-position confirmation; no dwell; independent overlap; unauthorized HIGH | V77 likely | proposed `/api/v1/tracking/geofences` family + `VehicleGeofenceTransitionedV1` | OPERATOR UI | three narrow permissions; Tenant; minimized location evidence | Logical location IDs only; no US-63 ownership/persistence reuse | US-50, US-51, US-52 | frozen US-48 trusted WGS84/Vehicle/source-time contracts | COMPLETE — `US-49-MANAGE-GEOFENCES-PRODUCT-DECISIONS-001.md` | Must prove geometry, transition/concurrency, Notification, PostgreSQL, accessibility and own E2E; no US-48 acceptance inheritance |
...
US-48 external acceptance remains on hold until physical FMC130/live Flespi prerequisites change. US-49 CS01 and CS02 are verified complete without story acceptance credit; CS03 owns evaluation orchestration and transition production.
