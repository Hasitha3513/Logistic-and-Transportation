...
| US-55 | Handle GPS Edge Cases | `tracking` | PRODUCT_DECISIONS_COMPLETE / READY_FOR_IMPLEMENTATION | P1 | C | H/H/H/H/H | US-48 ingestion/trusted state, hybrid Kafka/Redis/Timescale, US-78, Notification, Audit | Real device/provider loss, burst, reassignment, tamper and battery evidence for final acceptance | exact coordinate/accuracy/time/order/jump/freshness/battery thresholds; unsupported signals UNKNOWN; two-point recovery; immutable evidence | expected forward schema and optional canonical V2 require later separate authorization; V95 unchanged | proposed bounded `/api/v1/tracking/gps-exceptions` list/detail/acknowledge only | permission-gated operator page plus warnings on existing Tracking surfaces | two narrow permissions; Tenant; source-time binding; minimized DLT/audit/metrics | Tracking owns detection/evidence; Operations owns HIGH case workflow; Notification owns IN_APP delivery | CS01 domain/trust contracts next | Full rules frozen; no tamper/battery inference and no physical-acceptance inheritance | `US-55-HANDLE-GPS-EDGE-CASES-CS01-DOMAIN-TRUST-QUALITY-CONTRACTS-001` | Technical and physical acceptance remain separate |
...
US-48, US-50, US-52, US-53 and US-54 remain on independent external acceptance holds. US-49 is COMPLETE / ACCEPTED and accounting remains 73 / 87. US-54 technical closure remains valid, but no physical case was executed and simulation was not substituted. US-55 product decisions are frozen without claiming unavailable tamper/battery fidelity. The active queue is US-55 CS01 domain/trust contracts; Flyway remains V95.
