...
| US-53 | Replay Journeys | `tracking` | IMPLEMENTATION_IN_PROGRESS / CS04_COMPLETE | P2 | C | M/M/H/M/H | US-48 retained history; US-49/50/52 labelled overlays; Trip; Routing; Audit | Physical/provider evidence only for final acceptance | 7-day bounded chronological replay; deterministic 3 km/h, 5-minute, 50 m stop rule; explicit gaps/quality; no export or engine inference | V93 permission-only seed complete; no replay projection | three read-only body-query endpoints under `/api/v1/tracking/journey-replays` implemented | OPERATOR UI is CS05 | two narrow replay permissions enforced at literal HTTP and use-case boundaries; Tenant; no-store/location privacy; minimized audit | Timescale history is authoritative; published Trip/Routing only; overlays retain producer status | US-55 after core overlays | stable V86/V87 history; accepted US-49 and technical-only US-50/52 overlays | CS01–CS04 verified; Maven 1,807/1,807 and architecture 59/59 PASS; CS05 next | Core replay may proceed without US-48/50/52 physical acceptance; own final evidence required |
...
US-48, US-50 and US-52 remain on independent external acceptance holds. US-49 is COMPLETE / ACCEPTED and accounting remains 73 / 87. US-53 contracts, Trip prerequisite, Timescale/attribution adapters, deterministic stop analysis and CS04 API/RBAC/audit are complete. Continue with `US-53-REPLAY-JOURNEYS-CS05-FRONTEND-001`; Flyway head is V93.
