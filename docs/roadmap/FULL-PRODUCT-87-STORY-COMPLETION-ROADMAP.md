...
**Architecture enabler:** `P1-01` COMPLETE; current Flyway head `V83`
...
US-48 and US-50 remain on independent external acceptance holds. US-49 is COMPLETE / ACCEPTED. US-52 is `PRODUCT_DECISIONS_FROZEN / READY_FOR_IMPLEMENTATION`; accounting remains unchanged and V84 is absent.
