...
**Architecture enabler:** `P1-01` COMPLETE; current Flyway head `V98`
...
| US-55 | Handle GPS Edge Cases | `tracking` | IMPLEMENTATION_IN_PROGRESS / CS05_COMPLETE | P1 | C | H/H/H/H/H | US-48 ingestion/trusted state, hybrid Kafka/Redis/Timescale, US-78, Notification, Audit | Real device/provider loss, burst, reassignment, tamper and battery evidence for final acceptance | exact coordinate/accuracy/time/order/jump/freshness/battery thresholds; canonical V2 optional observations; unsupported signals UNKNOWN; two-point recovery; immutable evidence | V96 nullable V2 history/capabilities, V97 authoritative episodes/evidence, V98 existing-Tenant notification catalogue and Operations constraints | proposed bounded `/api/v1/tracking/gps-exceptions` list/detail/acknowledge only | permission-gated operator page plus warnings on existing Tracking surfaces | source-time capability lookup, retained binding authority, Tenant-qualified persistence/Redis keys and secrets absent | Tracking owns detection/evidence; Operations owns one HIGH fact; Notification owns one first-open IN_APP delivery | CS05 focused pure 12/12 and evaluator/Notification/PostgreSQL 12/12 PASS; full closure gates recorded in CS05 evidence | Physical evidence remains independent; future-Tenant defaults deferred pending governed workflow | `US-55-HANDLE-GPS-EDGE-CASES-CS06-APIS-RBAC-AUDIT-001` | Technical and physical acceptance remain separate |
...
US-48, US-50, US-52, US-53 and US-54 remain on independent external acceptance holds. US-49 is COMPLETE / ACCEPTED and accounting remains 73 / 87. US-54 technical closure remains valid, but no physical case was executed and simulation was not substituted. US-55 CS05 is complete without claiming unavailable physical tamper/battery fidelity. The active queue is US-55 CS06 API/RBAC/audit; Flyway is V98.
