...
**Current state:** 72 / 87 accepted; 15 / 87 remaining; Waves A and B are COMPLETE / CLOSED; Wave C is active; US-48 is implementation complete with physical acceptance on external-prerequisite hold; US-49 CS01–CS04A are complete and implementation continues
...
| US-49 | Manage Geofences | `tracking` | IMPLEMENTATION_IN_PROGRESS / CS01-CS04A_COMPLETE | P1 | C | H/M/H/M/H | US-48 position stream, Organization active-location lookup, Notification, Audit | NONE after telemetry exists | FROZEN: DEPOT/CUSTOMER_SITE/UNAUTHORIZED_ZONE; polygon-only; two-position confirmation; no dwell; independent overlap; unauthorized HIGH | V77 persistence; V78 permission seed | implemented `/api/v1/tracking/geofences` management/query family; `VehicleGeofenceTransitionedV1` remains CS05 | OPERATOR UI pending | three narrow permissions enforced at HTTP and use-case boundaries; Tenant; minimized location evidence | Published Tenant-aware Organization location lookup only; logical location IDs; no US-63 ownership/persistence reuse | US-50, US-51, US-52 | frozen US-48 trusted WGS84/Vehicle/source-time contracts | CS01 domain/ports, CS02 V77 persistence, CS03 evaluation/transitions, CS04 API/RBAC/audit and CS04A V78 seed COMPLETE | Must prove Notification, frontend, closure and independent E2E; no US-48 acceptance inheritance |
...
US-48 external acceptance remains on hold until physical FMC130/live Flespi prerequisites change. US-49 CS01–CS04A are verified complete without story acceptance credit; CS05 owns Notification integration and the durable transition event.
