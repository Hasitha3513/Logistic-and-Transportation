...
**Architecture enabler:** `P1-01` COMPLETE; current Flyway head `V84`
...
| US-52 | Monitor Route Deviations | `tracking` | PRODUCT_DECISIONS_FROZEN / READY_FOR_IMPLEMENTATION | P1 | C | H/H/H/M/H | US-48 trusted positions; Trip source-time assignment; Routing immutable revision geometry; Audit; Notification | Physical position/accuracy final evidence | route-revision tolerance 10–5,000 m; accuracy-expanded corridor; two-point confirmation; deterministic WARNING/HIGH; audited review | V85 expected after foundation V84; must recheck before creation | `/api/v1/tracking/route-deviations`; detected/escalated families frozen, not implemented | rules, truthful state, episodes and review; optional local preview | four narrow permissions; Tenant; no normal-response coordinates | Routing owns plan; Trip owns attribution; Tracking owns comparison/review evidence; Notification owns delivery | US-49, US-50, US-51 | additive Trip route-version population and Routing geometry lookup frozen for CS01; no foreign persistence | Product decision document complete; implementation and acceptance evidence pending | Independent physical safe-route acceptance; no US-48/49/50 inheritance |
...
US-48 and US-50 remain on independent external acceptance holds. US-49 is COMPLETE / ACCEPTED. US-52 is `PRODUCT_DECISIONS_FROZEN / READY_FOR_IMPLEMENTATION`; accounting remains unchanged. Foundation V84 enforces Vehicle Reading source identity, so US-52 must recheck the head and use V85 if it remains free.
