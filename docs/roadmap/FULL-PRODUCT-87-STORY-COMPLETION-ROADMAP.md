...
| US-87 | Detect User Risk | `identity` | PREREQUISITE_COMPLETE / DECISIONS_PROPOSED / IMPLEMENTATION_NOT_AUTHORIZED | P2 | E | H/M/H/H/H | US-74, US-75, US-80 and US-78 accepted as stories; actual reusable inputs require owner-published facts because audit/workflow are feature-owned; US-82 optional | IdP/session authority only for future MFA, strong shared-login evidence or enforcement | PROPOSED D1–D20: deterministic closed catalogue, advisory-first human review, explicit unknown/conflicting evidence, no fraud proof or automatic punishment | YES, ONLY AFTER DDL AUTHORIZATION; NO VERSION RESERVED | proposed bounded risk/review API and minimized source facts; no contracts authorized | proposed OPERATOR UI | highest: Tenant, behavioral data, SoD, privacy; current runtime has no MFA/device-bound session enforcement | Identity owns proposed assessment/review; source modules retain denial/validation/facts; no audit scraping or generic fraud engine | US-82 optional analytics, US-84 | product/security/privacy/records and first-wave source-owner approval | Approve D1–D20, initial signal/action codes, thresholds, retention, reviewers and exact first producer before CS01 | Technical fixtures remain distinct from real source/IdP/operator acceptance; `US-87-DETECT-USER-RISK-PREREQUISITE-AND-PRODUCT-DECISIONS-001.md` |
