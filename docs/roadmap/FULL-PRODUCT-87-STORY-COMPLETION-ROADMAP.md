...
**Current state:** 73 / 87 accepted; 14 / 87 remaining; Waves A and B are COMPLETE / CLOSED; Wave C is active; US-48, US-50, US-52, US-53 and US-54 are implementation/technical complete with independent physical acceptance holds; US-49 is COMPLETE / ACCEPTED
**Architecture enabler:** `P1-01` COMPLETE; current Flyway head `V105`
...
| US-48 | Track Vehicles Live | dedicated `tracking` bounded context | IMPLEMENTATION_COMPLETE / ACCEPTANCE_BLOCKED_EXTERNAL_SYSTEM | P0 | C | H/H/H/H/H | Fleet Vehicle identity, Identity, Tenancy, Audit and opaque credential resolution | Genuine supported physical GPS/provider telemetry required for final acceptance | Provider-neutral Flespi polling, bounded Traccar 6.15.3 HTTPS polling and Generic signed-HMAC ingress; effective-dated device/Vehicle binding, freshness/health and fail-safe duplicate/stale/outage handling | V73–V76; no Traccar migration | existing management and signed ingress; Traccar reuses provider SPI/management contracts | provider/device onboarding UI exists generically; explicit Traccar guided-flow evidence pending | existing three permissions; authenticated Tenant; opaque credentials; one authoritative provider interval | adapters cannot write Redis/Timescale/foreign persistence; Tracking remains provider-neutral | US-49–55 consume normalized technical evidence without acceptance inheritance | Any supported physical device through Flespi, Traccar or signed gateway plus operator sign-off | Traccar adapter backend verified; guided UI and real provider/device remain separate gates | External hold preserved; fixtures/simulation never substitute physical evidence |
...
| US-50 | Monitor Speed | `tracking` | IMPLEMENTATION_COMPLETE / ACCEPTANCE_BLOCKED_EXTERNAL_SYSTEM | P1 | C | H/M/H/M/H | US-48 normalized speed/trust/Vehicle/source time; published Trip source-time attribution; Notification; Audit | Physical provider/device speed field, native unit and normalization proof pending | route-config then Tenant fallback; no legal-limit claim; zero tolerance; two-sample deterministic episode; ten-minute repeat | V81 persistence; V82 permission seed; V83 Notification catalogue seed | `/api/v1/tracking/speed-monitoring`; durable `VehicleSpeedingDetectedV1` through P1-01 to Notification | permission-aware rules, state and episode UI complete | three narrow permissions; Tenant; minimized Driver/location data | Tracking detects; Trip attributes; Driver owns violation/discipline; Notification owns delivery | US-49, US-51, US-52 | frozen technical US-48 speed contract; no acceptance inheritance | acceptance technical slice 78/78 and frontend 10/10; CS07 Maven 1,656/0/0/15, race 123/123, Chromium 11/11 | `PHYSICAL_SPEED_FIDELITY_EVIDENCE_PENDING`; resume only on material external evidence |
| US-51 | Monitor Idle Time | `tracking` | TECHNICALLY_COMPLETE / PRODUCTION_SOURCE_ACTIVATION_PENDING / ACCEPTANCE_PENDING | P1 | C | M/M/M/M/M | US-48 canonical history/movement, effective device capabilities, Audit; Fuel estimate deferred | Production powertrain authority is absent and production lookup returns UNKNOWN; engine-running activation and final acceptance require verified native device evidence | APPROVED D1–D11: combustion/hybrid; native engine-running; 3 km/h, adjusted 50 m, five minutes/two samples, two-minute gap; no Phase-1 effects/fuel estimate | V105 verified: V104 permissions retained and exactly three Tenant-aligned state, episode and IDLE-dispatch indexes added | four approved read-only `/api/v1/tracking/idle-monitoring` routes implemented with bounded signed cursors, Tenant-safe lookups, no-store and minimized audit | permission-aware read-only state/history/detail/evidence UI complete with session cache clearing and truthful unavailable states | `IDLE_MONITOR_VIEW`, `IDLE_EVENT_VIEW`; independent HTTP/use-case/UI enforcement; Tenant; no coordinates/PII/provider raw facts | Tracking owns detection/evidence; published Fleet lookup is conservative UNKNOWN until source-time classification authority exists; V1/V2 remain ineligible | US-49, US-50, US-52 | No activation/final-acceptance identifier authorized; production activation needs verified powertrain and engine-running mappings | Technical closure PASS: fresh cross-layer 53/53 plus retained Maven 1,952/1,952, architecture 59/59, Vitest 346/346 and Chromium 4/4 | Technical fixtures close software only; physical evidence/operator sign-off remain mandatory |
| US-52 | Monitor Route Deviations | `tracking` | IMPLEMENTATION_COMPLETE / ACCEPTANCE_BLOCKED_EXTERNAL_SYSTEM | P1 | C | H/H/H/M/H | US-48 trusted positions; Trip source-time assignment; Routing immutable revision geometry; Audit; Notification | Physical position/accuracy final evidence | route-revision tolerance 10–5,000 m; accuracy-expanded corridor; two-point confirmation; deterministic WARNING/HIGH; audited review | V85 Trip prerequisite; V88 Routing geometry/Tracking persistence; V89 permission seed; V90 notification catalogue; V91 durable evaluation dispatch; V92 Tenant-leading query indexes | implemented `/api/v1/tracking/route-deviations`; durable detected/escalated Notification integration complete | permission-aware rule/state/episode/review UI and Chromium complete | four narrow permissions at HTTP/use-case boundaries; Tenant; no normal-response coordinates; correction SoD | Routing owns plan; Trip owns attribution; Tracking owns comparison/review evidence; Notification owns delivery | US-49, US-50, US-51 | Consolidated prerequisite and CS01–CS07 technical closure PASS; no foreign persistence | Maven 1,754/1,754, focused 488/488, architecture 59/59, Vitest 319/319 and Chromium 26/26 PASS | Final acceptance externally blocked: no physical field journey, real Dispatcher delivery or operator sign-off; US-53 core decisions may proceed |
| US-53 | Replay Journeys | `tracking` | TECHNICALLY_COMPLETE / IMPLEMENTATION_COMPLETE_ACCEPTANCE_BLOCKED_EXTERNAL_SYSTEM | P2 | C | M/M/H/M/H | US-48 retained history; US-49/50/52 labelled overlays; Trip; Routing; Audit | Genuine retained provider/device journey and operator sign-off | 7-day bounded chronological replay; deterministic 3 km/h, 5-minute, 50 m stop rule; explicit gaps/quality; no export or engine inference | V93 permission-only seed complete; no replay projection | three read-only body-query endpoints under `/api/v1/tracking/journey-replays`; 30 actor/120 Tenant requests per minute; five-second database timeout | permission-gated accessible responsive replay UI and producer-labelled overlay controls verified 6/6 in real Chromium; deployment rollback flag | two narrow replay permissions enforced at literal HTTP and use-case boundaries; Tenant; no-store/location privacy; minimized audit/metrics | Timescale history is authoritative; published Trip/Routing only; accepted US-49 and technical-only US-50/52 labels retained | US-55 after core overlays | stable V86/V87 history; accepted US-49 and technical-only US-50/52 overlays | Consolidated technical closure PASS: Maven 1,815/1,815, Vitest 325/325, architecture 59/59, Chromium 6/6 and 20-session performance | Field phase PASS 0 / FAIL 0; remaining cases blocked by external prerequisites; technical closure remains valid |
| US-54 | View Tracking Dashboard | `tracking` | TECHNICALLY_COMPLETE / IMPLEMENTATION_COMPLETE_ACCEPTANCE_BLOCKED_EXTERNAL_SYSTEM | P2 | C | H/L/H/M/M | US-48..53 technical producer contracts, published bulk Trip context, Notification own unread API | Genuine provider/device telemetry, privacy review and operator sign-off | bounded fleet summary/map/table; observed-speed motion; no idle; 24-hour labelled incidents; 0.01° live/recent density; 15-second visible polling | V94 permission seed; V95 Tenant-leading recent-speed index; no projection | implemented read-only `POST /api/v1/tracking/dashboard/query`; body filters, Tenant-bound cursor, no-store | responsive permission-gated dashboard, table/map fallback, density layer, polling/backoff and producer labels complete | conjunctive dashboard/coordinate/incident/replay permissions; Tenant; no PII/device/provider facts | Tracking aggregate uses Tracking ports and one published bulk Trip query; Notification queried independently | Independent technical closure PASS: focused 18/18, Maven 1,838/1,838, architecture 59/59, Vitest 330/330, Chromium 6/6 | Physical cases unexecuted; no simulation substituted and no producer acceptance inherited | Deferred `US-54-VIEW-TRACKING-DASHBOARD-FINAL-ACCEPTANCE-001`; execute US-55 decisions | Field acceptance remains externally blocked |
| US-55 | Handle GPS Edge Cases | `tracking` | TECHNICALLY_COMPLETE / IMPLEMENTATION_COMPLETE_ACCEPTANCE_BLOCKED_EXTERNAL_SYSTEM | P1 | C | H/H/H/H/H | US-48 ingestion/trusted state, hybrid Kafka/Redis/Timescale, US-78, Notification, Audit | Real device/provider loss, burst, reassignment, tamper and battery evidence for final acceptance | exact coordinate/accuracy/time/order/jump/freshness/battery thresholds; canonical V2 optional observations; unsupported signals UNKNOWN; two-point recovery; immutable evidence | V96 nullable V2 history/capabilities, V97 authoritative episodes/evidence, V98 integration, V99 permissions, V100 durable acknowledgement replay | bounded no-store `/api/v1/tracking/gps-exceptions` list/detail/evidence/acknowledge API | permission-gated list/detail/evidence/acknowledgement UI complete with explicit range, cursor and session controls | source-time capability lookup, retained binding authority, Tenant-qualified persistence/Redis/cursors/commands and secrets absent | Tracking owns detection/evidence; Operations owns one HIGH fact; Notification owns one first-open IN_APP delivery | Consolidated technical closure PASS; hybrid latest selects the newest eligible trusted PostgreSQL/Redis source; CS08 concurrency/performance evidence retained | Final field matrix: 0 PASS / 0 FAIL / 9 BLOCKED_EXTERNAL_PREREQUISITE; future-Tenant defaults deferred; Traccar production adapter is independent pending work | Open acceptance: `US-55-HANDLE-GPS-EDGE-CASES-FINAL-ACCEPTANCE-001`; independent queue: `US-55-TRACCAR-ADAPTER` | Technical and physical acceptance remain separate |
| US-72 | Enforce Compliance | justified `compliance` decision/evidence context; domains own facts | IMPLEMENTATION_IN_PROGRESS / CS01_COMPLETE_INACTIVE / POLICY_APPROVAL_PENDING | P1 | D | H/H/H/H/H | Fleet, Driver/Fleet, Freight/Hazmat, US-47 billing, US-83 retention, US-75 Audit, Identity, US-80 Workflow — platform prerequisites satisfied | Regulatory/tax policy authority; optional rules feed | CS01 structural identities, evidence vocabulary and four minimized fact-query ports complete; D1–D11 policy semantics remain proposed | REQUIRED AFTER DDL AUTHORIZATION; NO VERSION RESERVED | no public API/event; inactive Fleet/Driver, Freight/Hazmat and Billing fact-query port structures only | proposed OPERATOR UI | explicit Tenant identity; no permissions or activation | Avoid one expression-language “god engine”; explicit typed checks consume published facts | US-76 product decisions | product and qualified policy authority approval; Tracking physical holds are not dependencies for the proposed catalogue | Product owner and qualified policy authority approve D1–D11, initial jurisdiction, checks/effects/override/retention before CS02 | Vehicle/driver/cargo/hazmat/tax/regional/retention decisions are auditable and block/flag correctly; DoD-C |
...
| US-87 | Detect User Risk | `identity` | FIRST_WAVE_APPROVAL_PACKAGE_READY / IMPLEMENTATION_NOT_AUTHORIZED | P2 | E | H/M/H/H/H | Identity permission-ceiling source is present; audit/workflow remain feature-owned; US-82 optional | No external dependency for proposed first signal; IdP/session authority remains later-wave | PROPOSED: four Identity permission-ceiling actions; three distinct denials in 15 minutes; MEDIUM advisory review; no misconduct conclusion or automatic action | YES, ONLY AFTER DDL AUTHORIZATION; NO VERSION RESERVED | proposed minimized P1-01 denial fact, bounded review/appeal API; no contract active | proposed OPERATOR UI | Tenant; distinct reviewer; exact field allow-list; proposed 180-day retention; current runtime has no MFA/device-bound session enforcement | Identity owns source and assessment; no generic denial capture, audit scraping, Operations intake or foreign persistence | US-82 optional analytics, US-84 | product/security/privacy/records, Identity source-owner and architecture/data approval | Approve exact first-wave D1–D20 mapping before proposed CS01 | Technical fixtures remain distinct from authorized reviewer/producer acceptance; `US-87-DETECT-USER-RISK-PREREQUISITE-AND-PRODUCT-DECISIONS-001.md` |
...
**Parallel work:** US-49/50/52 product decisions proceeded against the frozen technical US-48 contract while physical acceptance remained on hold; US-53 and US-54 consumed those technical producer contracts without acceptance inheritance. US-55 decisions are frozen. US-51 software implementation may proceed after D1–D11 approval using controlled fixtures, while production engine-running activation and field acceptance remain separately blocked.
...
10. US-50 implementation and technical closure through V83 — COMPLETE; final acceptance is externally blocked pending physical speed fidelity, so Wave C proceeds with US-52.
11. US-51 is `TECHNICALLY_COMPLETE / PRODUCTION_SOURCE_ACTIVATION_PENDING / ACCEPTANCE_PENDING`; preserve its independent activation and field-acceptance gates.
12. US-52 product decisions — COMPLETE / FROZEN; proceed through CS01–CS07, technical closure and independent physical final acceptance without inheriting US-48/49/50 acceptance.
13. US-55 product decisions are COMPLETE; implement the controlled change sets while treating unavailable tamper/battery signals as UNKNOWN and preserving independent physical acceptance.
...
16. US-72 CS01 inactive structural foundations are COMPLETE; no runtime policy, schema, API, permission or event is active. Product and qualified policy authority must approve D1–D11 before CS02 or later change sets → closure → acceptance.
...
US-51 D1-D11 and CS01–CS07 are complete. Canonical V3 has a verified durable V101 history path,
effective-dated `ENGINE_RUNNING` vocabulary and V102 idle persistence/staged dispatch, while every
production source mapping remains gated. The V103 candidate-persistence prerequisite and D1–D5
evaluator are verified, normal durable IDLE claims are active, and V104 APIs/RBAC/audit are verified.
CS07 PostgreSQL/Kafka performance/recovery, V105 index hardening and consolidated US-51 technical
closure are verified. No executable US-51 activation or final-acceptance identifier is authorized;
the next action is a governed activation decision after authoritative Fleet classification and
verified native engine-running evidence exist.

US-48, US-50, US-52, US-53, US-54 and US-55 remain on independent external acceptance holds. US-49 is COMPLETE / ACCEPTED and accounting remains 73 / 87. US-55 field acceptance remains openly queued at `US-55-HANDLE-GPS-EDGE-CASES-FINAL-ACCEPTANCE-001` with 9 externally blocked requirements. Canonical polling, the bounded Traccar 6.15.3 adapter, guided Flespi/Traccar provider UI, safe provider health recovery, idempotency closure and post-extension technical closure are complete; Generic signed-HMAC continuity is preserved and real-provider evidence remains absent. US-51 production source activation and final physical acceptance remain separate holds. US-72 CS01 is inactive and later work remains policy-authority blocked. US-87 prerequisite analysis and its concrete first-wave Identity permission-ceiling approval package are complete, but the proposed D1–D20 mapping and CS01–CS07 sequence require product/security/privacy/records, Identity source-owner and architecture/data authorization. No independent implementation task is authorized. Flyway is V105.
