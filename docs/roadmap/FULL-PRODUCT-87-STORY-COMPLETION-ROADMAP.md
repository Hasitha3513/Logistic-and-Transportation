...
11. US-51 is `DECISION_READY_FOR_APPROVAL / IMPLEMENTATION_NOT_AUTHORIZED`; after D1–D11 approval begin proposed CS01 with production engine-running mappings disabled, then retain separate activation and field-acceptance gates.
