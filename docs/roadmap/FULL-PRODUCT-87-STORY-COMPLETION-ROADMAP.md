...
| US-87 | Detect User Risk | `identity` | PREREQUISITE_REVIEW_PROPOSED / IMPLEMENTATION_NOT_AUTHORIZED | P2 | E | H/M/H/H/H | US-74, US-75, US-80 and US-78 accepted; domain override/audit signals; US-82 optional analytics | Identity provider only for real MFA/SSO action if claimed | deterministic signals; severity; thresholds; false-positive review; enforcement matrix; privacy/retention; explainability | YES, ONLY AFTER AUTHORIZATION | security admin API + risk-signal/enforcement contracts | OPERATOR UI | highest: identity/session, behavioral data, fraud, MFA/lockout, SoD, Tenant | Start with explainable rules; no opaque ML; missing-field validation remains at domain boundary | US-82 deterministic analytics, US-84 | proposed prerequisite review; no implementation authorization | Signals/actions, review/appeal, retention, safe lockout and IdP test path frozen | Overrides/shared-login/fraud/delay produce explainable events; mandatory fields fail at source; configured reauth/restrict actions and audit pass; DoD-C |
