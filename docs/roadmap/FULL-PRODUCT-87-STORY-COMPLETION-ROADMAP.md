...
**Current state:** 72 / 87 accepted; 15 / 87 remaining; Waves A and B are COMPLETE / CLOSED; Wave C is active; US-48 is implementation complete with physical acceptance on external-prerequisite hold; US-49 is ready for product decisions against the frozen technical contract
...
**Waves A and B are COMPLETE / CLOSED; Wave C is active.** US-73 and US-78 are accepted. US-35, US-37, US-38, US-46, and US-47 final acceptance pass. US-48 is technically complete at V76 but physical acceptance is `ON_HOLD_EXTERNAL_PREREQUISITE`; the next task is `US-49-MANAGE-GEOFENCES-PRODUCT-DECISIONS-001`.
...
| US-49 | Manage Geofences | `tracking` | TECHNICAL_DEPENDENCY_SATISFIED / READY_FOR_PRODUCT_DECISIONS | P1 | C | H/M/H/M/H | US-48 position stream, Organization depot/customer-site references, Notification, Audit | NONE after telemetry exists | geometry/types; entry/exit hysteresis; dwell; unauthorized policy; alert recipients | YES | new geofence API + internal event contract | OPERATOR UI | RBAC; Tenant; location/zone sensitivity | Use logical site IDs; do not duplicate US-63 delivery-zone ownership | US-50, US-51, US-52 | frozen US-48 trusted WGS84/Vehicle/source-time contracts | Product decisions must freeze geometry and transition semantics | Valid entry/exit and unauthorized events, invalid polygon rejection, Tenant/device isolation and own E2E pass; no US-48 acceptance inheritance |
...
9. US-49 product decisions → implementation → closure → acceptance; technical dependency is satisfied without US-48 acceptance inheritance.
...
US-48 external acceptance remains on hold until physical FMC130/live Flespi prerequisites change. US-49 may consume only the frozen technical Tracking contracts and receives no inherited acceptance or completion credit.
