...
**Wave A is 2 / 2 COMPLETE / CLOSED and Wave B is OPEN.** US-73 and US-78 are accepted. US-35, US-37 and US-38 final acceptance pass. US-46 implementation remains acceptance pending; its V71 technical remediation is authorized. US-47 remains in Wave B. The next task is `US-46-DRIVER-PAYROLL-LINK-TECHNICAL-REMEDIATION-001`.
...
| US-46 | Process Driver Payroll Link | `driver` within Fleet (operational payroll-input owner) | IMPLEMENTATION_COMPLETE / ACCEPTANCE_PENDING | P1 | B | H/H/H/H/H | Driver, Trip, Audit, Identity, Tenancy, P1-01, US-73; Scheduling only after a separately accepted duty-fact contract | Controlled US-73 `FILE_JSON_V1`; no live HRMS | Four source-backed categories; explicit batch inputs; cutoff; immutable release/correction; provisional net input only | V68–V70 implemented; V71 remediation authorized | implemented API/UI/event family; closure gaps pending remediation | OPERATOR UI under Driver/AppLayout | four permissions; Tenant; preparer/approver SoD; minimized financial/Driver data | Payroll/HRMS owns final salary/tax/pension/payment; Finance owns posting; HRM blueprint remains PROPOSED | US-35, US-37, US-73, P1-01 | strengthened PostgreSQL/Chromium evidence required after remediation | Technical closure blocked mapping idempotency, delivery-state, validation timing and evidence gaps; V71 authorized | Remediate, rerun closure, then independent acceptance; accounting unchanged |
...
`US-46-DRIVER-PAYROLL-LINK-TECHNICAL-REMEDIATION-001`

It must implement only the authorized forward V71 and closure-gap remediation, then hand off to the technical-closure rerun without advancing story accounting.
