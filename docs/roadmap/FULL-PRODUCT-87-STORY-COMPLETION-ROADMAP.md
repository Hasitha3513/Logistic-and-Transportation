...
**Current state:** 72 / 87 accepted; 15 / 87 remaining; Waves A and B are COMPLETE / CLOSED; Wave C is active; US-48 is implementation complete with physical acceptance on external-prerequisite hold; US-49 CS01–CS03 and CS04A are complete and implementation continues
**Architecture enabler:** `P1-01` COMPLETE; current Flyway head `V78`
...
| US-49 | Manage Geofences | `tracking` | IMPLEMENTATION_IN_PROGRESS / CS01-CS03_AND_CS04A_COMPLETE | P1 | C | H/M/H/M/H | US-48 position stream, Organization active-location lookup, Notification, Audit | NONE after telemetry exists | FROZEN: DEPOT/CUSTOMER_SITE/UNAUTHORIZED_ZONE; polygon-only; two-position confirmation; no dwell; independent overlap; unauthorized HIGH | V77 persistence; V78 permission seed | proposed `/api/v1/tracking/geofences` family + `VehicleGeofenceTransitionedV1` | OPERATOR UI | three narrow permissions seeded for established administrative roles; Tenant; minimized location evidence | Logical location IDs only; no US-63 ownership/persistence reuse | US-50, US-51, US-52 | frozen US-48 trusted WGS84/Vehicle/source-time contracts | CS01 domain/ports, CS02 V77 persistence, CS03 evaluation/transitions and CS04A V78 RBAC seed COMPLETE | Must prove API/RBAC/audit, Notification, frontend, closure and independent E2E; no US-48 acceptance inheritance |
...
US-48 external acceptance remains on hold until physical FMC130/live Flespi prerequisites change. US-49 CS01–CS03 and CS04A are verified complete without story acceptance credit; the CS04 rerun owns management APIs, runtime RBAC and audit.
