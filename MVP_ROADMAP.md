...
> - **US-51 Selection:** D1–D11 and CS01–CS03 are complete. V102 adds Tenant-qualified idle state, episode, append-only evidence and staged durable `IDLE` dispatch while every production engine-running source remains gated.
> - **Immediate Next Action:** Execute `US-51-MONITOR-IDLE-TIME-CS04-EVALUATOR-001`; consume staged IDLE work only with the approved D1–D5 evaluator and preserve all source-activation and physical-acceptance holds.
...
| `US-51` | Monitor Idle Time | Authoritative engine-running versus movement duration; fuel estimate deferred | 🟡 `IMPLEMENTATION_IN_PROGRESS / CS03_COMPLETE` | V102 persistence and staged dispatch verified; production mappings and physical acceptance remain separately gated |
...
3. **Wave C — GPS and telematics:** US-48, US-50, US-52, US-53, US-54 and US-55 physical acceptance are on independent external-prerequisite holds; US-49 is accepted. US-51 D1-D11 and CS01–CS03 are complete at V102; CS04 idle evaluation is next while production engine-running activation and physical acceptance remain separate gates.
