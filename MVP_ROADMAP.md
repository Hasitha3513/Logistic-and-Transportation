...
> - **Active Focus:** Wave B is open; US-37 is accepted and US-35 implementation remains acceptance-blocked after the authorized Bunker ledger-order remediation passed.
> - **Immediate Next Action:** Execute `US-35-FUEL-CARDS-FINAL-ACCEPTANCE-001-RERUN`.
...
| `US-35` | Manage Fuel Cards | Card issuance, restrictions, imported transactions, reconciliation and misuse control | 🔴 `IMPLEMENTATION_COMPLETE / ACCEPTANCE_BLOCKED` | Authorized V65 Bunker ledger-order remediation passed; independent final-acceptance rerun next |
...
Queue Head:     US-35-FUEL-CARDS-FINAL-ACCEPTANCE-001-RERUN
```

1. **Wave A — Integration and exception-control foundations:** 2 / 2 COMPLETE / CLOSED (US-73 and US-78).
2. **Wave B — Fuel control and financial links:** US-37 COMPLETE; US-35 authorized Bunker ledger-order remediation passed and independent final acceptance is next; then US-38, US-46, US-47.
