...
> - **US-51 Selection:** D1–D11 and CS01–CS07 are complete. V105 adds exactly the three approved Tenant-aligned state, episode and IDLE-dispatch indexes; the Fleet query still returns `UNKNOWN` in production.
> - **Immediate Next Action:** Execute `US-51-MONITOR-IDLE-TIME-TECHNICAL-CLOSURE-001`; preserve all source-activation and physical-acceptance holds.
...
| `US-51` | Monitor Idle Time | Authoritative engine-running versus movement duration; fuel estimate deferred | 🟡 `IMPLEMENTATION_IN_PROGRESS / CS07_COMPLETE` | V105 query hardening plus PostgreSQL/Kafka concurrency, recovery, complete-build and Chromium gates verified; production mappings and physical acceptance remain separately gated |
...
Queue Head:     US-51-MONITOR-IDLE-TIME-TECHNICAL-CLOSURE-001
...
3. **Wave C — GPS and telematics:** US-48, US-50, US-52, US-53, US-54 and US-55 physical acceptance are on independent external-prerequisite holds; US-49 is accepted. US-51 D1-D11 and CS01–CS07 are complete; independent technical closure is next while production engine-running activation and physical acceptance remain separate gates.
