...
> - **Active Focus:** Wave B is open; US-37 is accepted and US-35 product decisions are frozen.
> - **Immediate Next Action:** Execute `US-35-FUEL-CARDS-IMPLEMENTATION-001`.
...
| `US-35` | Manage Fuel Cards | Card issuance, restrictions, imported transactions, reconciliation and misuse control | 🟡 `PRODUCT_DECISIONS_FROZEN / IMPLEMENTATION_NOT_STARTED` | `US-35-FUEL-CARDS-PRODUCT-DECISIONS-001.md` |
...
Queue Head:     US-35-FUEL-CARDS-IMPLEMENTATION-001
```

1. **Wave A — Integration and exception-control foundations:** 2 / 2 COMPLETE / CLOSED (US-73 and US-78).
2. **Wave B — Fuel control and financial links:** US-37 COMPLETE; US-35 decisions frozen and implementation next; then US-38, US-46, US-47.
