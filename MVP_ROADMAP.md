...
![Database](https://img.shields.io/badge/TimescaleDB%20%2F%20Flyway-V104-8a63d2.svg?style=for-the-badge&logo=postgresql)
...
| `US-51` | Monitor Idle Time | Authoritative engine-running versus movement duration; fuel estimate deferred | 🟡 `IMPLEMENTATION_IN_PROGRESS / CS05_COMPLETE` | V104 read-only APIs, exact RBAC and minimized audit verified; production mappings and physical acceptance remain separately gated |
