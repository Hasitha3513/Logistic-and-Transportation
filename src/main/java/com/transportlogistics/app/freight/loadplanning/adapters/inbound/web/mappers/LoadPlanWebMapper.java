...
public class LoadPlanWebMapper {
    ...
    public LoadValidationResultResponse toValidationResultResponse(LoadValidationResult result) {
        ...
        return new LoadValidationResultResponse(
                ...
                result.cargoWeightKg(),
                result.payloadCapacityKg(),
                result.payloadUtilizationPercent(),
                result.cargoVolumeM3(),
                result.volumeCapacityM3(),
                result.volumeUtilizationPercent(),
                result.projectedGrossWeightKg(),
                result.grossWeightLimitKg(),
                result.tareWeightKg(),
                ...
                result.gvwResult() != null ? result.gvwResult().name() : null,
