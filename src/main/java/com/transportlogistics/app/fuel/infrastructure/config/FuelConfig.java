...
class FuelConfig {
    ...
    FuelIssueUseCase fuelIssueUseCase(FuelIssueRepository issues, FuelIssueHistoryRepository history,
                                      ...
                                      FuelActorPort actors, FuelVehicleReadingPort vehicleReadings,
                                      FuelVoucherGenerator vouchers,
                                      FuelTransaction transactions, FuelEventPublisher events, Clock clock) {
        return new FuelIssueService(issues, history, stations, limits, vehicles, trips, actors, vehicleReadings,
                vouchers, transactions, events, clock);
    }
