...
public class TrackingController {
 ...
 @PostMapping("/devices/{id}/retire") @PreAuthorize("hasAuthority('TRACKING_DEVICE_MANAGE')") public Device retire(@PathVariable UUID id,@Valid @RequestBody VersionRequest r){return use.lifecycle(context(),id,r.version(),DeviceLifecycle.RETIRED);}
