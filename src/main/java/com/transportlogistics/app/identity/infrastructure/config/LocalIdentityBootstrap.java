...
class LocalIdentityBootstrap implements ApplicationRunner {
    private static final Set<String> MVP_PERMISSIONS = Set.of(
            ...
            "FUEL_EXCEPTION_VIEW", "FUEL_EXCEPTION_MANAGE", "FUEL_EXCEPTION_CORRECT",
            "FUEL_EXCEPTION_APPROVE", "FUEL_EXCEPTION_ESCALATE",
            ...
            "DELIVERY_SLOT_VIEW", "DELIVERY_SLOT_CREATE", "DELIVERY_SLOT_UPDATE", "DELIVERY_SLOT_ACTIVATE",
            "DELIVERY_SLOT_ASSIGN", "DELIVERY_SLOT_OVERRIDE", "DELIVERY_ANALYTICS_VIEW",
            ...
            "FREIGHT_REPORT_VIEW", "FREIGHT_REPORT_EXPORT",
            "DRIVER_PAYROLL_VIEW", "DRIVER_PAYROLL_PREPARE", "DRIVER_PAYROLL_APPROVE", "DRIVER_PAYROLL_EXPORT",
            "BILLING_VIEW", "BILLING_PREPARE", "BILLING_APPROVE", "BILLING_FINALIZE", "BILLING_EXPORT",
            "TRACKING_VIEW", "TRACKING_HISTORY_VIEW", "TRACKING_DEVICE_MANAGE",
            ...
            "JOURNEY_REPLAY_VIEW", "JOURNEY_REPLAY_INCIDENT_VIEW", "TRACKING_DASHBOARD_VIEW",
            "GPS_EXCEPTION_VIEW", "GPS_EXCEPTION_REVIEW"
    );
