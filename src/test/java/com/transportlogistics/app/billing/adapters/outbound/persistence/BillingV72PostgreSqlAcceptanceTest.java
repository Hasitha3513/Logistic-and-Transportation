...
class BillingV72PostgreSqlAcceptanceTest extends PostgreSqlIntegrationTest {
    ...
    @Test void v72CreatesTenantOwnedBillingSchemaAndFivePermissions(){
        assertThat(jdbc.queryForObject("select version from flyway_schema_history where success order by installed_rank desc limit 1",String.class)).isEqualTo("102");
