  ...
  webServer: [
    {
      ...
      env: {
        ...
        TRACKING_HYBRID_STORAGE_ENABLED: 'true',
        TRACKING_KAFKA_MANAGE_TOPIC: 'true',
        KAFKA_BOOTSTRAP_SERVERS: process.env.KAFKA_BOOTSTRAP_SERVERS || 'localhost:9094',
